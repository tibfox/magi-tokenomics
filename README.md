...
```bash
GOTOOLCHAIN=go1.25.3 go test ./itest/ -count=1 -p 1     # 186 contract tests, real wasm engine
...
All three contracts + reporter are complete, audited, and green: **186 contract tests, 174
